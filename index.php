    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="index.php">Institucional</a></li>
                        <li class="dropdown">
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <p><code>Márcio de Oliveira Dutra</code></p>
                <p><a class="btn btn-primary btn-lg " href='index.php?pagina=agendar_consulta.php' role="button">Agendar consulta</a></p>
            </div>
        </div>
...
<div class="footer ">
            <div class="container">
                <hr>
                <p class="text-muted text-center"><a href="http://www.codigofonteonline.com.br/" target="_blank">&copy; 2024 | Márcio Dutra</a></p>
            </div>
        </div>
